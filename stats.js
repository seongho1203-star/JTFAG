...
const ROUND_HOLES = {
    ...
    "7": {
        course: "어등-송정",
        par: [4, 4, 3, 4, 5, 4, 4, 3, 5,   4, 5, 4, 3, 4, 4, 3, 5, 4],
        rel: {
            "김지명": [1, 2, 0, 3, 3, 0, 1, 1, 0,   3, -1, 2, 0, 0, 1, 0, 0, 0],
            "박승수": [1, 1, 0, 4, 1, 0, 1, 1, 2,   0, 2, 1, 0, 4, 1, 2, 0, 0],
            "신성호": [1, 3, 1, 3, 1, 0, 1, 0, 0,   1, 1, 0, 1, 1, 2, 1, 0, 3],
            "이관교": [3, 1, -1, 0, 2, 1, -1, 1, 3,   1, 0, 0, 0, 1, 0, 2, 0, 1]
        }
    }
};
