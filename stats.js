...
const ROUND_HOLES = {
    ...
    "8": {
        course: "JNJ 진-정",
        par: [4, 4, 3, 5, 4, 3, 4, 5, 4,   4, 4, 3, 5, 4, 5, 4, 3, 4],
        rel: {
            "김지명": [1, -1, 2, 1, 1, 0, 1, 3, 0,   0, 1, 0, 0, 1, 2, 0, 0, -1],
            "박승수": [2, 1, 1, 3, 0, 0, 2, 2, 1,   2, 1, 1, 1, 1, 0, 1, 1, 2],
            "신성호": [2, 4, 0, 1, 3, 1, 3, 0, 3,   0, 0, 2, 1, 1, 2, 1, 2, 1],
            "이관교": [0, 2, 0, 1, 0, 1, 2, 0, 0,   0, 3, 1, 0, 2, 0, 1, 1, 3]
        }
    },
